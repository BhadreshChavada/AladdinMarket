...
private String[] mDataset;
    ...
    private ArrayList<Datum> productItems = new ArrayList<>();

    public SearchProductAdaper(ArrayList<Datum> productItems) {
   ...
   holder.productName.setText(productItems.get(position).getProduct_name());
        holder.sellerName.setVisibility(View.INVISIBLE);
        holder.productCost.setText(productItems.get(position).getProduct_price());
